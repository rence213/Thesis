<header class="main-header" >
  ...
  <nav class="navbar navbar-static-top" style="background-color:rgba(0,0,0,0.6);">
		...
		<li style="background-color:rgba(0,0,0,0.7);"><a class="wave-button" role="button"><i class="fa fa-database" style="font-size:15px;"></i> &nbsp <span style="margin-left:5px;">Data Center</span></a></li>
		</ul>
